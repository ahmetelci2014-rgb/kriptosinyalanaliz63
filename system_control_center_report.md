...
- Üretim: 2026-08-19T07:54:32+00:00
- Genel sağlık: 🟡 **YELLOW**
...
| Scalp Radar | 🟢 GREEN | 1 | 🟡 İZLE | 0.69s |
| Pump/Dump Radar | 🟢 GREEN | 0 | 🟢 KORU / İZLE | 0.03s |
| Swing Shadow V5 | 🟡 YELLOW | 0 | ⚪ SWING V4 GÖLGE VERİ TOPLA | 23.05s |
| Ana Trend Pozisyon Shadow V2 | 🟡 YELLOW | 4 | ⚪ VERİ TOPLA | 23.18s |
| Tüm Piyasa Keşif Radarı | 🟢 GREEN | 0 | 🟡 İZLE / DOĞRULA | 5.28s |
| Momentum Shadow V2 | 🟢 GREEN | - | 🟠 GÖLGEDE TUT / CANLIYA ALMA | 5.18s |
| Range Cycle Shadow V4 | 🟢 GREEN | - | 🟡 GÖLGEDE TUT | 5.94s |
| Portfolio Risk | 🟢 GREEN | - | 🟡 PORTFÖY RİSKİNİ İZLE | 4.65s |
| Decision Engine | 🟢 GREEN | - | ⚪ KARAR YOK | 10.64s |
| Prescription Engine | 🟢 GREEN | - | ⚪ KARAR YOK | 10.64s |
...
| Büyük Hareket Fiyat Rotası | 🟢 GREEN | 0 | ⚪ KARAR YOK | 0.53s |
