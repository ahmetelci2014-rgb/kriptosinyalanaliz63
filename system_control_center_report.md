...
- Üretim: 2026-08-14T18:08:45+00:00
- Genel sağlık: 🟢 **GREEN**
...
| Scalp Radar | 🟢 GREEN | 1 | 🟢 KORU | 0.40s |
| Pump/Dump Radar | 🟢 GREEN | 0 | 🟢 KORU / İZLE | 0.53s |
| Swing Shadow V4 | 🟢 GREEN | 0 | ⚪ SWING V4 GÖLGE VERİ TOPLA | 0.74s |
| Ana Trend Pozisyon Radarı | 🟢 GREEN | 3 | ⚪ VERİ TOPLA | 0.88s |
| Tüm Piyasa Keşif Radarı | 🟢 GREEN | 0 | ⚪ VERİ TOPLA | 0.05s |
| Momentum Shadow | 🟢 GREEN | - | 🟠 GÖLGEDE TUT / CANLIYA ALMA | 0.12s |
| Range Cycle Shadow | 🟢 GREEN | - | 🔴 CANLIYA ALMA / YENİDEN TASARLA | 0.52s |
| Portfolio Risk | 🟢 GREEN | - | 🟡 PORTFÖY RİSKİNİ İZLE | 0.47s |
| Decision Engine | 🟢 GREEN | - | ⚪ KARAR YOK | 8.30s |
| Prescription Engine | 🟢 GREEN | - | ⚪ KARAR YOK | 8.30s |
