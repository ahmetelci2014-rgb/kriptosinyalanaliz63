...
- Üretim: 2026-08-16T09:42:31+00:00
- Genel sağlık: 🟡 **YELLOW**
...
|---|---:|---:|---|---:|
| Premium MTF | 🟢 GREEN | 4 | 🟢 KORU | 0.14s |
| Scalp Radar | 🟢 GREEN | 0 | 🟡 İZLE | 0.08s |
| Pump/Dump Radar | 🟢 GREEN | 0 | 🟢 KORU / İZLE | 0.02s |
| Swing Shadow V4 | 🟢 GREEN | 0 | ⚪ SWING V4 GÖLGE VERİ TOPLA | 0.97s |
| Ana Trend Pozisyon Radarı | 🟢 GREEN | 4 | ⚪ VERİ TOPLA | 1.11s |
| Tüm Piyasa Keşif Radarı | 🟢 GREEN | 0 | ⚪ VERİ TOPLA | 1.81s |
| Momentum Shadow | 🟢 GREEN | - | 🟠 GÖLGEDE TUT / CANLIYA ALMA | 1.72s |
| Range Cycle Shadow | 🟢 GREEN | - | 🔴 CANLIYA ALMA / YENİDEN TASARLA | 1.50s |
| Portfolio Risk | 🟢 GREEN | - | 🟡 PORTFÖY RİSKİNİ İZLE | 0.84s |
| Decision Engine | 🟡 YELLOW | - | ⚪ KARAR YOK | 36.41s |
| Prescription Engine | 🟡 YELLOW | - | ⚪ KARAR YOK | 36.41s |
