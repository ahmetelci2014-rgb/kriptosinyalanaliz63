...
def main() -> None:
    ...
    # conflicts explicit before the tracking stack records them. PRE-ENTRY Shadow
    # sits after tracking and only observes selected PREP setups; it never changes
    # the returned live decision. Reversal Capture stays outside that stack so
    # recent DEAD alerts and open shadow positions can both keep scan priority.
